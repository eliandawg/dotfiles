...
(doom! :input
       ...
       (go +lsp +tree-sitter)         ; the hipster dialect (graphql +lsp)    ; Give queries a REST
       ...
       (org +dragndrop +pandoc +present +roam2 +pretty)               ; organize your plain life in plain text
