...
*** Conf.d
**** Abbreviations
#+begin_src fish :tangle ./stow/.config/fish/conf.d/abbr.fish
if type -q eza
...
#+end_src
**** Homebrew
#+begin_src fish :tangle ./stow/.config/fish/conf.d/brew.fish
...
**** Misc
***** Functions
#+begin_src fish :tangle ./stow/.config/fish/conf.d/functions.fish
...
#+end_src
***** Paths
#+begin_src fish :tangle ./stow/.config/fish/conf.d/path.fish
fish_add_path "~/.local/bin"
fish_add_path "~/.config/emacs/bin/"
fish_add_path "~/.cargo/bin/"
#+end_src
***** Variables
#+begin_src fish :tangle ./stow/.config/fish/conf.d/misc.fish
set -Ux LSP_USE_PLISTS true # For emacs lsp-mode

set -U fish_key_bindings fish_vi_key_bindings
#+end_src
**** ~ssh-agent~
#+begin_src fish :tangle ./stow/.config/fish/conf.d/ssh-agent.fish
if systemctl --user is-active ssh-agent > /dev/null
    set -x SSH_AUTH_SOCK "$XDG_RUNTIME_DIR/ssh-agent.socket"
end
#+end_src
**** Tide prompt
#+begin_src fish :tangle ./stow/.config/fish/conf.d/tide.fish
# [prompt]
...
#+end_src
**** ~trash-put~
#+begin_src fish :tangle ./stow/.config/fish/conf.d/trash-put.fish
if type -q trash-put
    abbr rm trash-put
end
#+end_src
**** ~vterm~
#+begin_src fish :tangle ./stow/.config/fish/conf.d/vterm.fish
...
#+end_src
**** WSL
Use ~ssh.exe~ if running in WSL.
#+begin_src fish :tangle ./stow/.config/fish/conf.d/wsl.fish
...
#+end_src
**** ~zoxide~
#+begin_src fish :tangle ./stow/.config/fish/conf.d/zoxide.fish
if type -q zoxide
